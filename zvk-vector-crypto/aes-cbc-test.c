...
static const struct aes_routine kAESRoutines[NUM_ROUTINES] = {
    // AES-128
    {
        .name = "zvkns_aes128_encode_vv_lmul1",
        .descr = "AES-128 encode, vv variant, LMUL=1",
        .fn = &zvkns_aes128_encode_vv_lmul1,
        .keylen = 128,
        .min_vlen = 128,
        .direction = kEncode,
    },
    {
        .name = "zvkns_aes128_decode_vv_lmul1",
        .descr = "AES-128 decode, vv variant, LMUL=1",
        .fn = &zvkns_aes128_decode_vv_lmul1,
        .keylen = 128,
        .min_vlen = 128,
        .direction = kDecode,
    },
    // AES-256
    {
        .name = "zvkns_aes256_encode_vv_lmul1",
        .descr = "AES-256 encode, vv variant, LMUL=1",
        .fn = &zvkns_aes256_encode_vv_lmul1,
        .keylen = 256,
        .min_vlen = 128,
        .direction = kEncode,
    },
    {
        .name = "zvkns_aes256_decode_vv_lmul1",
        .descr = "AES-256 decode, vv variant, LMUL=1",
        .fn = &zvkns_aes256_decode_vv_lmul1,
        .keylen = 256,
        .min_vlen = 128,
        .direction = kDecode,
    },
